...
# HOME=$ALICE_HOME
# eval dfx canister install token --argument="'(\"Test Token Logo\", \"Test Token Name\", \"Test Token Symbol\", 3, 1000000, pijkx-rzclc-f7cd2-iyme3-pnukq-ejweg-oc6iq-5rprv-zhcnj-a62ex-vqe, 0)'"
